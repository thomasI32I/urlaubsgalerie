 ...
 *
 */
public class ImageGridComponent extends JPanel {
    ...
    private class ImageSelectionListener implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent event) {
            ...
            if (!event.getValueIsAdjusting()) {
                ...
                if (image != null) {
                    metaDataComponent.setInput(new ImageDataTableModel(image.getMetaDataList()));
                }
            }
        }
    }
     ...
     */
    public ImageGridComponent(MetaDataComponent metaDataComponent) {
        ...
        imageGrid.addListSelectionListener(new ImageSelectionListener());
     ...
     * 
     * @param numberOfImagesToDisplay The number of {@link GridImage}'s to display.
